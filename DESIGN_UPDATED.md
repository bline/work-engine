...
Variant structure therefore defines the model's **manipulable environment**: observable state plus the affordances available to change that state, bounded by invariant structure and evaluated against the objective and consequences.
