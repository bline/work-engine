...
1. [`revision-bound-review-artifacts`](revision-bound-review-artifacts/proposal.md)
   ...
   and applicability consequences built on the separately formed shared
   evidence-lineage candidate.
...
This decomposition deliberately does not decide whether panel selection and
synthesis eventually require separate capabilities. Current evidence has not
shown that they are independently decidable product changes. It also does not
decide whether proposal review or a shared proposal-and-implementation review
profile is the final owner of review-specific semantics, or whether the newly
formed evidence-lineage candidate proves to be a valid shared foundation.
