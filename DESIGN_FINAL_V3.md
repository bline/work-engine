...
When an attempted route fails, retain the smallest durable consequence needed to prevent unnecessary reconsideration: what was tried, what premise justified trying it, and what observation invalidated it. The failed attempt should become evidence about the route rather than inert history.
